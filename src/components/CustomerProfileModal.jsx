    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[92vh] overflow-hidden flex flex-col">
                {/* Header - Compact */}
                <div className="bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-700 dark:to-slate-800 px-5 py-3 border-b border-slate-200 dark:border-slate-700">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            onClick={onClose}
                            className="p-1.5 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-lg transition-colors ml-3"
                        >
                ...
                <div className="border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                    <div className="flex gap-1 px-4">
                        <button
                            ...
                            className={`px-4 py-3 text-sm font-semibold transition-colors border-b-2 ${activeTab === 'profile'
                        ...
                        <button
                            ...
                            className={`px-4 py-3 text-sm font-semibold transition-colors border-b-2 ${activeTab === 'financial'
                                ? 'border-lavpop-blue text-lavpop-blue'
                                : 'border-transparent text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-300'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-3 text-sm font-semibold transition-colors border-b-2 ${activeTab === 'behavior'
                                ? 'border-lavpop-blue text-lavpop-blue'
                                : 'border-transparent text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-300'
                                }`}
                        >
                        ...
                        <button
                            ...
                            className={`px-4 py-3 text-sm font-semibold transition-colors border-b-2 ${activeTab === 'history'
                                ? 'border-lavpop-blue text-lavpop-blue'
                                : 'border-transparent text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-300'
                                }`}
                        >
                                ...
                                <div className="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-2.5 mb-2">
                                    <div className="flex gap-1.5">
                                        <select
                                            ...
                                            className="px-2 py-1.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-lg text-xs font-semibold text-slate-700 dark:text-slate-300"
                                        >
                                        ...
                                        <input
                                            ...
                                            className="flex-1 px-2 py-1.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 rounded-lg text-xs"
                                            onKeyPress={(e) => e.key === 'Enter' && addCommunication()}
                                        />
                                        <button
                                            onClick={addCommunication}
                                            className="px-3 py-1.5 bg-lavpop-blue text-white rounded-lg font-semibold text-xs hover:bg-blue-600 transition-colors flex items-center gap-1.5"
                                        >
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-4 gap-2">
                                    <div className="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-2.5">
                                        ...
                                        <div className="text-xl font-bold text-slate-800 dark:text-white">{customer.transactions}</div>
                                    </div>
                                    <div className="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-2.5">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div className={`${riskConfig.bgClass} rounded-lg p-3 border-2 ${riskConfig.bgClass.replace('bg-', 'border-')}`}>
                                        ...
                                        <div className={`text-xl font-bold ${riskConfig.textClass}`}>{riskConfig.pt}</div>
                                    </div>
                                    <div className="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-3">
                                        <div className="text-[10px] font-bold text-slate-400 uppercase mb-0.5">Probabilidade de Retorno</div>
                                        <div className="text-xl font-bold text-slate-800 dark:text-white">{customer.returnLikelihood}%</div>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    <div className="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-2.5">
                                        ...
                                        <div className="text-xl font-bold text-slate-800 dark:text-white">{customer.servicesPerVisit}</div>
                                    </div>
                                    <div className="bg-sky-50 dark:bg-sky-900/20 rounded-lg p-2.5 border border-sky-200 dark:border-sky-800">
                                        ...
                                        <div className="text-xl font-bold text-sky-700 dark:text-sky-300">{customer.washPercentage}%</div>
                                    </div>
                                    <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-lg p-2.5 border border-emerald-200 dark:border-emerald-800">
                                        ...
                                        <div className="text-xl font-bold text-emerald-700 dark:text-emerald-300">{customer.dryPercentage}%</div>
                                    </div>
                                </div>
                            </div>
                        </div>
